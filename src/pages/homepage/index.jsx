...
const HomePage = () => {
  ...
  return (
    <div
      ...
      style={{ maxWidth: 1440, margin: "0 auto", marginTop: "20px" }}
    >
      <Row gutter={[20, 20]} style={{ backgroundColor: "#fff" }}>
        <Col md={4} sm={0} xs={0} style={{ padding: "20px 25px" }}>
        ...
        <Col md={20} xs={24} style={{ padding: "20px 25px" }}>
          <Row>
          ...
          <Row style={{ display: "flex", justifyContent: "center" }}>
            <Pagination defaultCurrent={current} total={total} responsive />
          </Row>
        </Col>
      </Row>
    </div>
